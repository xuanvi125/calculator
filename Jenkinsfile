                ...
                sshagent(['ec2-ssh-key']) { // Thay 'your-credential-id' bằng ID của credential trong Jenkins
                    script {
                        ...
                        sh '''
                            ...
                            scp -o StrictHostKeyChecking=no /var/jenkins_home/workspace/calculator-cicd/target/calculator-0.0.1-SNAPSHOT.jar ec2-user@18.143.67.75:/home/ec2-user/
                            # SSH vào remote server và chạy file JAR
                            ssh -o StrictHostKeyChecking=no ec2-user@18.143.67.75 '
